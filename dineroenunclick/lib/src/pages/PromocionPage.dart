...
class _PromocionPageState extends State<PromocionPage> with AutomaticKeepAliveClientMixin<PromocionPage>{
  ...
  _modalInfoAmpliacion(BuildContext context) async {
    modalConfirmacion(context, 'Confirmación !', 'Esta seguro de generar este crédito?', (){
  ...
  int _getProductoIdByPlazo(int plazo, String productos,  String frec){
    ...
    plazos.forEach((prod){
      ...
      if(obj[0] == frec && int.parse(obj[1]) == plazo && double.parse(obj[2]) == prom.tasa){        
